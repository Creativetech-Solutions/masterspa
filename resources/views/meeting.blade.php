        ...
        <form action="{{ url('/hotel') }}" method="POST" class="pref-form">
            ...
            <div class="col-lg-12">
                 <div class="form-group col-xs-12 col-sm-6">
                    <label>So we can provide appropriate seating in the meeting room, how many people from this registration will be attending the actual MEETING on  November 3rd?</label>
                </div>
