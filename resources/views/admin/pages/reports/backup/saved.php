        ...
        <div id="content">
            ...
            <section class="widget">
                ...
                foreach($page_data as $key=> $row){
                    ...
                    echo '<a href="'.base_url().'admin/Reports/generateSavedReport/'.$row->reportID.'"><small data-title="Download" class="sdown tooltip"><i class="icon-download-alt icon-white"></i></small></a>';
